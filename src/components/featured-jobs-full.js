    ...
    <div className='m-auto max-w-7xl sm:px-6 lg:px-8'>
      <div className='px-10 pt-10 pb-20 text-center'>
        ...
        <div className='grid grid-cols-3 gap-10 my-16'>
          ...
          <div className='flex p-4 bg-white rounded-md shadow-md opacity-30'>
            <div className='flex-shrink-0'>
          ...
          <div className='flex p-4 bg-white rounded-md shadow-md opacity-25'>
            <div className='flex-shrink-0'>
          ...
          <div className='flex p-4 bg-white rounded-md shadow-md opacity-10'>
            <div className='flex-shrink-0'>
