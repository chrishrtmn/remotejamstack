    ...
    <div className='w-full m-auto max-w-7xl'>
      <div className='mb-16 text-center'>
        ...
        <p className='px-6 mx-auto mt-2 text-lg text-center text-gray-400 max-w-prose'>
          An overview of our statistics during pre-release. Metrics are updated
          periodically and may not be current during this period.
        </p>
      ...
      <div className='grid grid-cols-3 gap-10'>
        ...
        <a
          href='#subscribe'
          className='px-6 py-4 text-gray-400 transition-all bg-gray-700 rounded-md shadow-md hover:bg-gray-600 group'
        >
          <div className='flex justify-between mb-2 text-lg font-medium text-gray-400'>
