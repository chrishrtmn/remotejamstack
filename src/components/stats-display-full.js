const StatsDisplayFull = () => (
  <div className='m-auto max-w-7xl sm:px-6 lg:px-8'>
    <div className='px-10 py-20'>
      <h2 className='text-xl font-medium text-gray-800'>Site statistics</h2>

      <div className='grid grid-cols-3 gap-10 mt-8 mb-20'>
        <div className='flex px-6 py-4 bg-white rounded-md shadow-md'>
          <div className='flex-shrink-0'>
            <div className='mb-2 font-medium text-gray-500 text-md'>
        ...
        <div className='flex px-6 py-4 bg-white rounded-md shadow-md'>
          <div className='flex-shrink-0'>
            ...
            <div className='text-4xl font-bold text-gray-800'>1,000+</div>
          </div>
        </div>
