            ...
            <div className='px-4 md:px-10'>
              <div className='py-10 text-sm border-b border-gray-200'>
                <p className='mb-0'>
                  ...
                  what we do and publish all new features &amp; upcoming
                  requests we'd like to work on to this public roadmap.
                </p>
                {/* <p>
                <Link href='#subscribe'>
              ...
              <div className='py-10 border-b border-gray-200'>
                ...
                <ul className='mt-2 space-y-2 list-disc ml-14'>
                  ...
                  <li>
                    Create a 3-column feature section for landing page
                    explaining Jamstack
                  </li>
                  ...
                  <li>Job alerts for new submissions</li>
                </ul>
              </div>
              {/* End Planned */}
              {/* Backlog */}
              <div className='py-10'>
                ...
                <ul className='mt-2 space-y-2 list-disc ml-14'>
                  ...
                  <li>Pay Later option for forwarding payment link</li>
                </ul>
              </div>
              {/* End Backlog */}
            </div>
