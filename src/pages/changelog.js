    ...
    <>
      ...
      <div className='px-4 pt-10 pb-20 sm:px-6 lg:px-8'>
        <div className='w-full m-auto max-w-prose'>
          <h2 className='pb-10 text-4xl font-bold text-gray-800'>Changelog</h2>
          <div className='px-10 bg-white border border-gray-200 rounded-md shadow-md'>
            <div className='py-10 text-sm border-b border-gray-200'>
              <p className='mb-4'>
                ...
                what we do and publish all new features &amp; improvements to
              ...
              <p>
                ...
                to our newsletter to get the latest changelog updates.
              </p>
            </div>
            {/* Changelog Event */}
            <div className='py-10 border-b border-gray-200'>
              ...
              <ul className='mt-2 space-y-2 list-disc ml-14'>
                <li>Improvement example #1.</li>
              </ul>
            </div>
            {/* Changelog Event End */}
            {/* Changelog Event */}
            <div className='py-10 border-b border-gray-200'>
              <div className='text-lg text-gray-400'>December 31, 2020</div>
              <div className='mt-4 text-xl font-bold'>
                <svg
                  className='inline-block w-6 mr-2 -mt-1 text-red-500'
                  xmlns='http://www.w3.org/2000/svg'
              ...
              <ul className='mt-2 space-y-2 list-disc ml-14'>
                <li>
                  Internally released to friends and family to browse and/or
                  sign up to test out the site for bugs and provide feedback
                  ahead of the upcoming beta release.
                </li>
              </ul>
            </div>
            {/* Changelog Event End */}
