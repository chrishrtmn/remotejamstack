        ...
        <div className='w-full m-auto max-w-prose'>
          ...
          <div className='bg-white border border-gray-200 rounded-md shadow-md'>
            ...
            <div className='px-4 md:px-10'>
              ...
              {/* Changelog Event */}
              <div className='py-10 border-b border-gray-200'>
                <div className='text-lg text-gray-400'>January 29, 2021</div>
                <div className='mt-4 text-xl font-bold'>
                  <svg
                    className='inline-block w-6 mr-2 -mt-1 text-red-500'
                    xmlns='http://www.w3.org/2000/svg'
                ...
                <ul className='mt-2 space-y-2 list-disc ml-14'>
                  <li>
                    ...
                    <Link href='/employers#faq'>
                      <a className='text-red-500'>FAQ</a>
                    </Link>{' '}
                    section has been included to our site. Feel free to contact
                    us with any questions not explained there.
                  </li>
                </ul>
              </div>
              {/* Changelog Event End */}
